...
### Objetivo
El objetivio de este proyecto es Implementar un grafo con lista de adyacencia y aplicar una coloración de vértices con un método greedy.

### lo que utilizamos:
Para proyecto utilizamos el código base creado en clase, de modo que teniamos una orientación para poder comenzar, a este mismo le realizamos los siguientes cambios e implementaciones para poder cumplir los requisitos solicitados. 
